  ...
  return (
    <>
      <section className=" overflow-hidden px-4 sm:px-6 mt-10 sm:flex sm:flex-col gap-4 md:justify-center md:items-center">
        ...
        <div className="bg-white p-[2px] mt-6 rounded-xl bg-gradient-to-r from-primary to-brandPrimaryBlue sm:w-[300px]">
      ...
      <section className="relative">
        ...
        <div className="overflow-hidden flex after:content[''] after:dark:from-brandDark after:to-transparent after:from-background after:bg-gradient-to-l after:right-0 after:bottom-0 after:top-0 after:w-20 after:z-10 after:absolute before:content[''] before:dark:from-brandDark before:to-transparent before:from-background before:bg-gradient-to-r before:left-0 before:top-0 before:bottom-0 before:w-20 before:z-10 before:absolute">
          {[...Array(2)].map((arr) => (
      ...
      <section className="px-4 sm:px-6 flex justify-center items-center flex-col relative">
        ...
        <div className="w-[30%] blur-[120px] rounded-full h-32 absolute bg-brandPrimaryPurple/50 -z-10 top-22" />
      ...
      <section className="relative">
        ...
        <div className="w-full blur-[120px] rounded-full h-32 absolute bg-brandPrimaryPurple/50 -z-100 top-56"/>
            ...
            <CustomCard key={card.planType}
              ...
              cardHeader={
                <CardTitle className="text-2xl font-semibold">
                  {card.planType === PRICING_PLANS.proplan && (
                    <>
                      <div className="hidden dark:block w-full blur-[120px] rounded-full h-32 absolute bg-brandPrimaryPurple/80 -z-10 top-0 "/>
                      <Image
                        src={Diamond}
                        alt="Pro Plan Icon"
